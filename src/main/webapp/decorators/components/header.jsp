				...
				<div class="col-lg-3">
					<div class="header-phone ">
						...
						<div class="text">
							...
							<p class="font-weight-bold number">1900 6969</p>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
						...
						<div>
							...
							<ul class="category-menu">
								<c:forEach items="${categoryList}" var="category">
									<li class="cat-item">
										<a href="<c:url value="/product?filter=${category.id}" />">${category.name}</a>
									</li>
								</c:forEach>
							</ul>
						</div>
										...
										<ul class="header-top-list">
											<li class="dropdown-trigger language-dropdown"><a href=""><i class="icons-left fas fa-user"></i>
			                                    ...
			                                    <ul class="dropdown-box" style="width: 180px;">
			                                        <li> <a href="<c:url value="/user/profile" />">Hồ sơ</a></li>
		...
		<div class="off-canvas-inner">
			...
			<nav class="off-canvas-nav">
				<ul class="mobile-menu menu-block-2">
					...
					<li class="menu-item-has-children"><a href="#">Lang - Eng<i
			...
			<div class="off-canvas-bottom">
				<div class="contact-list mb--10">
					<a href="" class="sin-contact"><i class="fas fa-mobile-alt"></i>(12345)
						78790220</a> <a href="" class="sin-contact"><i
						class="fas fa-envelope"></i>examle@handart.com</a>
				</div>
				<div class="off-canvas-social">
					<a href="#" class="single-icon"><i class="fab fa-facebook-f"></i></a>
					<a href="#" class="single-icon"><i class="fab fa-twitter"></i></a>
					<a href="#" class="single-icon"><i class="fas fa-rss"></i></a> <a
						href="#" class="single-icon"><i class="fab fa-youtube"></i></a> <a
						href="#" class="single-icon"><i class="fab fa-google-plus-g"></i></a>
